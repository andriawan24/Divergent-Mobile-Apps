...
import com.andriawan.divergent_mobile_apps.databinding.ItemHistoryDiagnoseDiseaseBinding
...
import com.andriawan.divergent_mobile_apps.models.history_diagnose.Result
import com.andriawan.divergent_mobile_apps.utils.RecyclerDIffUtil
import java.math.RoundingMode
import kotlin.math.roundToInt

class DiseaseHistoryAdapter: RecyclerView.Adapter<DiseaseHistoryAdapter.ViewHolder>() {

    private var diseaseList = emptyList<Result>()

    class ViewHolder(private val binding: ItemHistoryDiagnoseDiseaseBinding): RecyclerView.ViewHolder(binding.root) {

        @SuppressLint("SetTextI18n")
        fun bind(disease: Result) {
            binding.result = disease
        ...
        companion object {
            fun from (parent: ViewGroup) : ViewHolder {
                ...
                val binding = ItemHistoryDiagnoseDiseaseBinding.inflate(inflater, parent, false)
